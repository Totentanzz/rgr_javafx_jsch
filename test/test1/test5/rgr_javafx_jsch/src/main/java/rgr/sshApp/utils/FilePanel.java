...
public abstract class FilePanel extends VBox implements Initializable {
    ...
    public void moveToSelectedDir(MouseEvent mouseEvent) {
        if (mouseEvent.getClickCount()==2) {
            ...
            if (selectedFile != null && selectedFile.getFileName().equals("..")) {
               ...
               String newDir = getResolvedDirectory(selectedFile,currentPath);
    ...
    abstract LinkedList<FileInfo> getFileList(String path) throws IOException;

    abstract LinkedList<String> getRootDirectories();

    abstract String getInitialPath();

    abstract String getParentDirectory(String currentPath);

    public abstract String getResolvedDirectory(FileInfo selectedFile,String currentPath);
